...
export const TruthTreeNodeComponent: vue.Component = {
    ...
    <i v-if="node.isValid() === 'not_parsable'" class="fas fa-exclamation-triangle" title="This is not parsable."></i>
    <i v-else-if="node.isValid() === true && node.isDecomposed() === true" class="fas fa-check" :title="node.getFeedback()"></i>
